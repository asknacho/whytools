...
const doMain = async (account, locationid, sleep, text) => {
  ...
  console.log(chalk`{green [?] Sedang Mem Follow, Like and Comment All Akun LocationID: ${locationid}\n}`);
  try {
    var cursor;
    var count = 0;
    do {
...
console.log(chalk`{bold.green
  Ξ TITLE  : WHY TOOLS FLA [FOLLOW-LIKE-COMMENT TARGET LOCATION-ID]
  Ξ CODE   : WYTOOLS 35239 (officialwhytools)
